...
L=p.Popcorn,A=/^(#([\w\-\_\.]+))$/,y=[],G=false,w={events:{hash:{},apis:{}}},H=function(){return p.requestAnimationFrame||p.webkitRequestAnimationFrame||p.mozRequestAnimationFrame||p.oRequestAnimationFrame||p.msRequestAnimationFrame||function(a){p.setTimeout(a,16)}}(),b=function(a,c){return new b.p.init(a,c||null)};b.version="0358736";b.isSupported=true;b.instances=[];b.p=b.prototype={init:function(a,c){var d;if(typeof a==="function")if(q.readyState==="interactive"||q.readyState==="complete")a(q,
